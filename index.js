...
const Game = require('./RPGGameManager');
...
app.post("/sms", (req, res) =>{
    ...
    let aReply = oGames[sFrom].HandleInput(sMessage);
    ...
    //Quickly close program, for debugging purposes
    if (sMessage == 'halt')
    {
        session.close();
        process.exit();
...
session = app.listen(port, () => console.log('Example app listening on port ' + port + '!'));